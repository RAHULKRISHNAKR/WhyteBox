    ...
    createLayerMesh(layer, scene, position, options = {}) {
        ...
        try {
            ...
            if (result && result.mesh) {
                // Attach layer metadata to mesh for later reference
                result.mesh.metadata = {
                    layerId: layer.id,
                    layerName: layer.name,
                    layerType: layer.type,
                    layerData: layer, // Full layer data for expansion
                    ...result.mesh.metadata
                };
            }
            ...
            console.error(`Error creating layer mesh for ${layer.id}:`, error);
            return null;
        }
    }
}
